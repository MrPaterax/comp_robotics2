...
class Camera(object):
    ...
    def compute_camera_matrix(self):
        ...
        intrinsic_matrix[0,2] = self.image_size[1] / 2
        intrinsic_matrix[1,2] = self.image_size[0] / 2
        intrinsic_matrix[2,2] = 1  # TODO: compute camera intrinsic_matrix from camera parameters
        projection_matrix = p.computeProjectionMatrixFOV(self.fov_height, self.image_size[1]/self.image_size[0], self.near, self.far)  # TODO: compute projection_matrix from camera parameters
